...
# [sunnymonster.dev](https://www.sunnymonster.dev)

The source code to my website.

## License
This project follows the REUSE specification. Refer to the various file headers and .license files for the licensing details.
...
This project runs the `reuse` tool as a pre-commit hook.
